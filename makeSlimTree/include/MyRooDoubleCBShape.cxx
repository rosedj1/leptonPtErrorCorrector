...
ClassImp(MyRooDoubleCBShape) 

 MyRooDoubleCBShape::MyRooDoubleCBShape(const char *name, const char *title, 
                        RooAbsReal& _x,
                        RooAbsReal& _mean,
                        RooAbsReal& _width,
                        RooAbsReal& _alpha1,
 ...
 MyRooDoubleCBShape::MyRooDoubleCBShape(const MyRooDoubleCBShape& other, const char* name) :  
 ...
 double MyRooDoubleCBShape::evaluate() const
 {
 ...
 Int_t MyRooDoubleCBShape::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* range) const
 { 
 ...
 Double_t MyRooDoubleCBShape::analyticalIntegral(Int_t code, const char* rangeName) const
 {
   assert(code==1) ;
